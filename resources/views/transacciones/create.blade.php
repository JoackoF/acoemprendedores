...
<div class="container mx-auto px-4">
    ...
    <form action="{{ route('transacciones.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="codigo_transaccion" id="codigo_transaccion" class="w-full px-4 py-2 border rounded">
        </div>
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <input type="number" step="0.01" name="monto" id="monto" class="w-full px-4 py-2 border rounded">
        </div>
        <div class="mb-4">
            <label for="fecha_transaccion" class="block text-gray-700">Fecha de Transacción</label>
            <input type="date" name="fecha_transaccion" id="fecha_transaccion" class="w-full px-4 py-2 border rounded">
        </div>
